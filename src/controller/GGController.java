...
public class GGController {
    ...
    private class BuyValidationHandler implements EventHandler<MouseEvent> {
        @Override
        public void handle(MouseEvent event) {
    ...
    private class PaymentHandler implements EventHandler<MouseEvent> {
        ...
        public void handle(MouseEvent event) {
            ...
            if (tf.getId().equals("CartBuyButton"))
                ...
                makePaymentView(Arrays.asList(database.getGame().get(Integer.parseInt(tf.getId()))),
                        database.getGame().get(Integer.parseInt(tf.getId())).getPrices().getPrice());
    ...
    public void makePaymentView(List<Game> gameList, double price) {
        ...
        this.paymentView.buyPressed(new BuyValidationHandler());
    }
}
